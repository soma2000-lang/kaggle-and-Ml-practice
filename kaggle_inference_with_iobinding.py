...
def predict_scores_offsets_from_volume_using_ort(
    ...
    tile_scores = torch.zeros([batch_size, 6, window_size[0]//2, window_size[1]//2, window_size[2]//2], dtype=torch_dtype, device=torch_device)
    tile_offsets = torch.zeros([batch_size, 3, window_size[0]//2, window_size[1]//2, window_size[2]//2], dtype=torch_dtype, device=torch_device)
